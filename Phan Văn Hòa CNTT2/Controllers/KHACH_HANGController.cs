...
namespace Phan_Văn_Hòa_CNTT2.Controllers
{
    public class KHACH_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MA_KHACH_HANG,TEN_KHACH_HANG,EMAIL,SO_DIEN_THOAI,DIA_CHI,NGAY_TAO")] KHACH_HANG kHACH_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MA_KHACH_HANG,TEN_KHACH_HANG,EMAIL,SO_DIEN_THOAI,DIA_CHI,NGAY_TAO")] KHACH_HANG kHACH_HANG)
        {
            if (ModelState.IsValid)
            {
