...
namespace Phan_Văn_Hòa_CNTT2.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MA_SAN_PHAM,TEN_SAN_PHAM,MO_TA,GIA,NGAY_TAO")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MA_SAN_PHAM,TEN_SAN_PHAM,MO_TA,GIA,NGAY_TAO")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
